...
public class B2CStoreCatalogPropertiesTest {

  //----------------------------------------
  /** Class version string */
  public static final String CLASS_VERSION = 
    "$Id: //hosting-blueprint/CSA/version/11.3/Applications/B2CStore/Base/src/test/java/atg/projects/store/catalog/B2CStoreCatalogPropertiesTest.java#1 $$Change: 1385662 $";
  
  //----------------------------------------------------------------------------
  // STATIC MEMBERS
  //----------------------------------------------------------------------------
  
  /** The B2CStoreCatalogProperties that will be tested */
  private static B2CStoreCatalogProperties mStoreCatalogProperties = null;
   ...
   * the B2CStoreCatalogProperties instance to be used in this test.
   * 
  ...
  public static void setUpBeforeClass() throws ServletException {
    mNucleus = NucleusTestUtils.startNucleusWithModules(
      ...
      B2CStoreCatalogPropertiesTest.class,
      "B2CStoreCatalogPropertiesTest",
      "/atg/Initial");

    // Set up StoreCatalogProperties for the tests.
    mStoreCatalogProperties = (B2CStoreCatalogProperties)
  ...
  @Test
  public void testDefaultSizePropertyName() {
    assertEquals("size", mStoreCatalogProperties.getSizePropertyName());
  }
  
  @Test
  public void testSetSizePropertyName() {
    mStoreCatalogProperties.setSizePropertyName(TEST);
    assertEquals(TEST, mStoreCatalogProperties.getSizePropertyName());

    // Set the property back to its default value
    mStoreCatalogProperties.setSizePropertyName("size");
  }
