 ...
 * provides the color, the getSizePropertyName( method will return the string value for
 * the property name as used in the repository definition.
 *
 * @author Oracle
 * @version $Id: //hosting-blueprint/CSA/version/11.3/Applications/B2CStore/Base/src/main/java/atg/projects/store/catalog/B2CStoreCatalogProperties.java#1 $
 * @updated $DateTime: 2017/03/09 10:29:42 $
 */
public class B2CStoreCatalogProperties extends StoreCatalogProperties {

  // Class version string
  public static final String CLASS_VERSION = "$Id: //hosting-blueprint/CSA/version/11.3/Applications/B2CStore/Base/src/main/java/atg/projects/store/catalog/B2CStoreCatalogProperties.java#1 $$Change: 1385662 $";
   ...
   *   Sets the name of the property that contains the size of a SKU.
   */
