 ...
 *
 * @author Oracle
 * @version $Id: //hosting-blueprint/CSA/version/11.3/Applications/B2CStore/src/main/java/atg/projects/store/assembler/navigation/preview/StorePreviewNavigationStateProcessor.java#1 $$Change: 1385662 $
...
public class StorePreviewNavigationStateProcessor extends StoreNavigationStateProcessor {
  ...
  public static final String CLASS_VERSION = 
    "$Id: //hosting-blueprint/CSA/version/11.3/Applications/B2CStore/src/main/java/atg/projects/store/assembler/navigation/preview/StorePreviewNavigationStateProcessor.java#1 $$Change: 1385662 $";
  ...
  protected void updateStateWithSpecifiedCategory(String pCategoryId, NavigationState pNavigationState) {
    ...
    if (dimValFromCache == null) {
      ...
      try {
        ...
        AssemblerTools.getApplicationLogging().vlogError(
          e, "An error occurred retrieving item {0} from the repository", pCategoryId);
      }
    }
    else {
    ...
    pNavigationState.getUrlFilterState().setNavigationFilters(navigationFilters);
