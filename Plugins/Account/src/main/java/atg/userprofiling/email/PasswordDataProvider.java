...
/**
 * A TemplateDataProvider that adds the users first name to the template data.
 */
public class PasswordDataProvider extends GenericService implements TemplateDataProvider {

  /** Class version string */
  public static String CLASS_VERSION = "$Id: //hosting-blueprint/CSA/version/11.3/Plugins/Account/src/main/java/atg/userprofiling/email/PasswordDataProvider.java#1 $$Change: 1385662 $";
  ...
  /** Change password from property name. */
  public static final String CHANGE_PASSWORD_FROM = "changePasswordFromAddress";
  ...
  public String getEmailFrom(String pSiteId) {
    try{
      ...
      return (String)site.getPropertyValue(CHANGE_PASSWORD_FROM);
    }
  ...
  /**
   * Adds the first name to the template data map.
   *
   * @param pEmailParameters
   *   Email parameters.
   * @return The first name in the template data map.
   */
  public Map processTemplateData(Map pEmailParameters){
    Map passwordData = new HashMap(1);
