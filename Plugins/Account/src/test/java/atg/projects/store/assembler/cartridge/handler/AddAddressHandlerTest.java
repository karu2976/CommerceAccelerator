...
/**
 * This unit test will test the methods of the AddAddressHandler class.
 *
 * @author Oracle
 * @version $Id: //hosting-blueprint/CSA/version/11.3/Plugins/Account/src/test/java/atg/projects/store/assembler/cartridge/handler/AddAddressHandlerTest.java#1 $$Change: 1385662 $
...
public class AddAddressHandlerTest {
  ...
  public static final String CLASS_VERSION =
    "$Id: //hosting-blueprint/CSA/version/11.3/Plugins/Account/src/test/java/atg/projects/store/assembler/cartridge/handler/AddAddressHandlerTest.java#1 $$Change: 1385662 $";

  //---------------------------------------------------------------------------
  // CONSTANTS
  //---------------------------------------------------------------------------

  private static AddAddressHandler mAddAddressHandler = null;
  ...
  private static final String ADD_ADDRESS_HANDLER_PATH = "/atg/endeca/assembler/cartridge/handler/AddAddress";
  ...
  public void before(){
    ...
    mAddAddressHandler = (AddAddressHandler) request.resolveName(ADD_ADDRESS_HANDLER_PATH, true);
    assertNotNull(mAddAddressHandler);
  }
  ...
  /**
   * Test process method of the add address handler.
   */
  @Test
  public void testProcess() throws CartridgeHandlerException {
    ContentItem result = mAddAddressHandler.process(new BasicContentItem());

    // Make sure the information required to add an address is returned in the content item.
