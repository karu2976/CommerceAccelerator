...
/**
 * This unit test will test the methods of the AccountPersonalInformationHandler class.
 *
 * @author Oracle
 * @version $Id: //hosting-blueprint/CSA/version/11.3/Plugins/Account/src/test/java/atg/projects/store/assembler/cartridge/handler/AccountPersonalInformationHandlerTest.java#1 $$Change: 1385662 $
 * @updated $DateTime: 2017/03/09 10:29:42 $
 */
public class AccountPersonalInformationHandlerTest {

  /** Class version string */
  public static final String CLASS_VERSION =
    "$Id: //hosting-blueprint/CSA/version/11.3/Plugins/Account/src/test/java/atg/projects/store/assembler/cartridge/handler/AccountPersonalInformationHandlerTest.java#1 $$Change: 1385662 $";

  //---------------------------------------------------------------------------
  // CONSTANTS
  //---------------------------------------------------------------------------

  private static AccountPersonalInformationHandler mAccountPersonalInformationHandler = null;
  ...
  private static final String PERSONAL_INFORMATION_HANDLER_PATH = "/atg/endeca/assembler/cartridge/handler/AccountPersonalInformation";
  ...
  public static void setUpBeforeClass() throws ServletException {
    mNucleus = NucleusTestUtils.startNucleusWithModules(
      ...
      "AccountPersonalInformationHandlerTest",
      "/atg/Initial");
  ...
  public void before(){
    ...
    mAccountPersonalInformationHandler = (AccountPersonalInformationHandler) request.resolveName(PERSONAL_INFORMATION_HANDLER_PATH, true);
    assertNotNull(mAccountPersonalInformationHandler);
  }
  ...
  public static void tearDownAfterClass() throws IOException, ServiceException {
    ...
    mAccountPersonalInformationHandler = null;
  ...
  public void testProcess() {
    ContentItem result = mAccountPersonalInformationHandler.process(new BasicContentItem());

    // The profile gets added by invoking the actor chain. What's returned
    // in the profile may vary depending on what has been configured.
    assertTrue(result.containsKey("profile"));
    assertTrue(result.containsKey("placeholderText"));
  }
}
