...
/**
 * This unit test will test the methods of the EditAddressHandler class.
 *
 * @author Oracle
 * @version $Id: //hosting-blueprint/CSA/version/11.3/Plugins/Account/src/test/java/atg/projects/store/assembler/cartridge/handler/EditAddressHandlerTest.java#1 $$Change: 1385662 $
 * @updated $DateTime: 2017/03/09 10:29:42 $
 */
public class EditAddressHandlerTest {

  /** Class version string */
  public static final String CLASS_VERSION =
    "$Id: //hosting-blueprint/CSA/version/11.3/Plugins/Account/src/test/java/atg/projects/store/assembler/cartridge/handler/EditAddressHandlerTest.java#1 $$Change: 1385662 $";

  //---------------------------------------------------------------------------
  // CONSTANTS
  //---------------------------------------------------------------------------

  private static EditAddressHandler mEditAddressHandler = null;
  ...
  private static final String EDIT_ADDRESS_HANDLER_PATH = "/atg/endeca/assembler/cartridge/handler/EditAddress";
  ...
  public void before(){
    ...
    mEditAddressHandler = (EditAddressHandler) request.resolveName(EDIT_ADDRESS_HANDLER_PATH, true);
    assertNotNull(mEditAddressHandler);
  }
   ...
   */
  @Test
  public void testProcess() throws ClassNotFoundException, IntrospectionException, InstantiationException,
    RepositoryException, IllegalAccessException, CartridgeHandlerException
  {
    // Set the defaults on the profile
    addAddressToProfile("Home", false);

    // Address to edit
    ServletUtil.getCurrentRequest().setParameter("addressNickname", "Home");

    // Check they are in the content item
    ContentItem result = mEditAddressHandler.process(new BasicContentItem());

    assertTrue(result.containsKey("addressNickname"));
    assertEquals("Home", result.get("addressNickname"));
