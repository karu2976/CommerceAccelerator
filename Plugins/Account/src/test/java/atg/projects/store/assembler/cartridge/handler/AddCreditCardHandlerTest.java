...
/**
 * This unit test will test the methods of the AddCreditCardHandler class.
 *
 * @author Oracle
 * @version $Id: //hosting-blueprint/CSA/version/11.3/Plugins/Account/src/test/java/atg/projects/store/assembler/cartridge/handler/AddCreditCardHandlerTest.java#1 $$Change: 1385662 $
 * @updated $DateTime: 2017/03/09 10:29:42 $
 */
public class AddCreditCardHandlerTest {

  /** Class version string */
  public static final String CLASS_VERSION =
    "$Id: //hosting-blueprint/CSA/version/11.3/Plugins/Account/src/test/java/atg/projects/store/assembler/cartridge/handler/AddCreditCardHandlerTest.java#1 $$Change: 1385662 $";

  //---------------------------------------------------------------------------
  // CONSTANTS
  //---------------------------------------------------------------------------

  private static AddCreditCardHandler mAddCreditCardHandler = null;
  ...
  private static final String ADD_CREDIT_CARD_HANDLER_PATH = "/atg/endeca/assembler/cartridge/handler/AddCreditCard";
  ...
  public void before(){
    ...
    mAddCreditCardHandler = (AddCreditCardHandler) request.resolveName(ADD_CREDIT_CARD_HANDLER_PATH, true);
    assertNotNull(mAddCreditCardHandler);
  }
  ...
  /**
   * Test process method of the add CreditCard handler.
   */
  @Test
  public void testProcess() throws CartridgeHandlerException {
    ContentItem result = mAddCreditCardHandler.process(new BasicContentItem());

    // Make sure the information required to add an CreditCard is returned in the content item.
