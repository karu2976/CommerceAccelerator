...
/**
 * This unit test will test the methods of the AccountOrderHistoryHandler class.
 * 
 * @author Oracle
 * @version $Id: //hosting-blueprint/CSA/version/11.3/Plugins/Account/src/test/java/atg/projects/store/assembler/cartridge/handler/AccountOrderHistoryHandlerTest.java#1 $$Change: 1385662 $ 
 * @updated $DateTime: 2017/03/09 10:29:42 $
 */
public class AccountOrderHistoryHandlerTest {

  /** Class version string */
  public static final String CLASS_VERSION =
    "$Id: //hosting-blueprint/CSA/version/11.3/Plugins/Account/src/test/java/atg/projects/store/assembler/cartridge/handler/AccountOrderHistoryHandlerTest.java#1 $$Change: 1385662 $";

  //----------------------------------------------------------------------------
  // CONSTANTS
  //----------------------------------------------------------------------------

  private static AccountOrderHistoryHandler mAccountOrderHistoryHandler = null;
  ...
  private static final String ORDER_HISTORY_HANDLER_PATH = "/atg/endeca/assembler/cartridge/handler/AccountOrderHistory";
   ...
   * the AccountOrderHistoryHandler instance to be used in this test.
   * 
  ...
  public static void setUpBeforeClass() throws ServletException {
    mNucleus = NucleusTestUtils.startNucleusWithModules(
      ...
      AccountOrderHistoryHandlerTest.class,
      "AccountOrderHistoryHandlerTest",
      "/atg/Initial");
  ...
  public static void tearDownAfterClass() throws IOException, ServiceException {
    ...
    mAccountOrderHistoryHandler = null;
  ...
  public void before(){
    ...
    mAccountOrderHistoryHandler = (AccountOrderHistoryHandler) request.resolveName(ORDER_HISTORY_HANDLER_PATH, true);
    assertNotNull(mAccountOrderHistoryHandler);
  }
  ...
  public void testProcess() {
    ...
    ContentItem result = mAccountOrderHistoryHandler.process(new BasicContentItem());

    assertTrue(result.containsKey("myOrders"));
    List filtered = (List) result.get("myOrders");

    // This user has 2 orders
  ...
  public void testProcess2() {
    Profile profile = (Profile) ServletUtil.getCurrentRequest().resolveName(PROFILE);
    mStoreProfileTools.createNewUser("userIdWithoutOrders", "user", profile);
    ServletUtil.setCurrentUserProfile(profile);

    ContentItem result = mAccountOrderHistoryHandler.process(new BasicContentItem());
    assertFalse(result.containsKey("myOrders"));
  }
}
