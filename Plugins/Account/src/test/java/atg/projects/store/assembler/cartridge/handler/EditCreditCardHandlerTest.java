...
/**
 * This unit test will test the methods of the EditCreditCardHandler class.
 *
 * @author Oracle
 * @version $Id: //hosting-blueprint/CSA/version/11.3/Plugins/Account/src/test/java/atg/projects/store/assembler/cartridge/handler/EditCreditCardHandlerTest.java#1 $$Change: 1385662 $
 * @updated $DateTime: 2017/03/09 10:29:42 $
 */
public class EditCreditCardHandlerTest {

  /** Class version string */
  public static final String CLASS_VERSION =
    "$Id: //hosting-blueprint/CSA/version/11.3/Plugins/Account/src/test/java/atg/projects/store/assembler/cartridge/handler/EditCreditCardHandlerTest.java#1 $$Change: 1385662 $";

  //---------------------------------------------------------------------------
  // CONSTANTS
  //---------------------------------------------------------------------------

  private static EditCreditCardHandler mEditCreditCardHandler = null;
  ...
  private static final String EDIT_CREDIT_CARD_HANDLER_PATH = "/atg/endeca/assembler/cartridge/handler/EditCreditCard";
  ...
  public void before(){
    ...
    mEditCreditCardHandler = (EditCreditCardHandler) request.resolveName(EDIT_CREDIT_CARD_HANDLER_PATH, true);
    assertNotNull(mEditCreditCardHandler);
  }
   ...
   */
  @Test
  public void testProcess() throws RepositoryException, IntrospectionException,
    PropertyNotFoundException, CartridgeHandlerException
  {
    // Add card to profile
    addCardToProfile("Visa", false);

    // Card to edit
    ServletUtil.getCurrentRequest().setParameter("cardNickname", "Visa");

    // Check they are in the content item
    ContentItem result = mEditCreditCardHandler.process(new BasicContentItem());

    assertTrue(result.containsKey("cardNickname"));
    assertEquals("Visa", result.get("cardNickname"));
    assertTrue(result.containsKey("countries"));
    assertTrue(result.containsKey("expiryYears"));
  }
}
