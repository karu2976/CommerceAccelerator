...
/**
 * This is handler provides the order number that is submitted successfully.
 *
 * @author Oracle
 * @version $Id: //hosting-blueprint/CSA/version/11.3/Plugins/Checkout/src/main/java/atg/projects/store/assembler/cartridge/handler/OrderConfirmationHandler.java#1 $$Change: 1385662 $
 * @updated $DateTime: 2017/03/09 10:29:42 $
 */
public class OrderConfirmationHandler extends NavigationCartridgeHandler {

  /** Class version string */
  public static String CLASS_VERSION =
    "$Id: //hosting-blueprint/CSA/version/11.3/Plugins/Checkout/src/main/java/atg/projects/store/assembler/cartridge/handler/OrderConfirmationHandler.java#1 $$Change: 1385662 $";
  
  //---------------------------------------------------------------------------
  // CONSTANTS
  //---------------------------------------------------------------------------
  
  /** Key in the content item for current order. */
  ...
  /**
   * This method adds the last successful order to the content item.
   *  
   * @param pContentItem
  ...
  public ContentItem process(ContentItem pContentItem) throws CartridgeHandlerException {
    pContentItem.put(CURRENT_ORDER, getShoppingCart().getLast());
    return pContentItem;
  }
}