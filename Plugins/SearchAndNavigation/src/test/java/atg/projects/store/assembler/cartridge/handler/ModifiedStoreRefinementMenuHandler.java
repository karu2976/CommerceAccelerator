 ...
 * 
 * @author Oracle
 * @version $Id: //hosting-blueprint/CSA/version/11.3/Plugins/SearchAndNavigation/src/test/java/atg/projects/store/assembler/cartridge/handler/ModifiedStoreRefinementMenuHandler.java#1 $$Change: 1385662 $
 * @updated $DateTime: 2017/03/09 10:29:42 $
 */
public class ModifiedStoreRefinementMenuHandler extends StoreRefinementMenuHandler {

  /** Class version string */
  public static String CLASS_VERSION = 
    "$Id: //hosting-blueprint/CSA/version/11.3/Plugins/SearchAndNavigation/src/test/java/atg/projects/store/assembler/cartridge/handler/ModifiedStoreRefinementMenuHandler.java#1 $$Change: 1385662 $";
  ...
  /**
   * This wrapper method gives us access to the super class getSliderRangeFilter method.
   *
   * @param pCategoryRefinementMenu
   *   The RefinementMenu to be passed to super.filterCategoryFacetsByDate
   * @return
   *   The RefinementMenu returned from super.filterCategoryFacetsByDate.
   */
  public RefinementMenu filterCategoryFacetsByDateAccessor(RefinementMenu pCategoryRefinementMenu)
    throws CartridgeHandlerException {
    
    return super.filterCategoryFacetsByDate(pCategoryRefinementMenu);
  }
