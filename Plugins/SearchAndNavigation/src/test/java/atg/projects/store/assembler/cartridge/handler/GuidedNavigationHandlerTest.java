...
/**
 * This unit test will test the methods of the GuidedNavigationHandler class.
 * 
 * @author Oracle
 * @version $Id: //hosting-blueprint/CSA/version/11.3/Plugins/SearchAndNavigation/src/test/java/atg/projects/store/assembler/cartridge/handler/GuidedNavigationHandlerTest.java#1 $$Change: 1385662 $
 * @updated $DateTime: 2017/03/09 10:29:42 $
 */
public class GuidedNavigationHandlerTest {

  /** Class version string */
  public static final String CLASS_VERSION = 
    "$Id: //hosting-blueprint/CSA/version/11.3/Plugins/SearchAndNavigation/src/test/java/atg/projects/store/assembler/cartridge/handler/GuidedNavigationHandlerTest.java#1 $$Change: 1385662 $";
  
  //----------------------------------------------------------------------------
  // STATIC MEMBERS
  //----------------------------------------------------------------------------

  /** The GuidedNavigationHandler that will be tested. */
  private static GuidedNavigationHandler mGuidedNavigationHandler = null;
   ...
   * the GuidedNavigationHandler instance to be used in this test.
   * 
   * @throws Exception
  ...
  public static void setUpBeforeClass() throws ServletException {
    mNucleus = NucleusTestUtils.startNucleusWithModules(
      ...
      GuidedNavigationHandlerTest.class,
      "GuidedNavigationHandlerTest",
      "/atg/Initial");

    DynamoHttpServletRequest request = setUpCurrentRequest();

    // Set up GuidedNavigationHandler.
    mGuidedNavigationHandler = (GuidedNavigationHandler)
      request.resolveName("/atg/endeca/assembler/cartridge/handler/GuidedNavigation", true);
    
    assertNotNull(mGuidedNavigationHandler);
  }
   ...
   */
  @Test
  public void testGetStoreCartridgeTools() {
    StoreCartridgeTools storeCartridgeTools = mGuidedNavigationHandler.getStoreCartridgeTools();
    assertNotNull(storeCartridgeTools);
    mGuidedNavigationHandler.setStoreCartridgeTools(storeCartridgeTools);
    assertNotNull(mGuidedNavigationHandler.getStoreCartridgeTools());
  }
  ...
  @Test
  public void testWrapConfig() throws CartridgeHandlerException {
    assertNotNull(mGuidedNavigationHandler.wrapConfig(new BasicContentItem()));
  }
  ...
  public void testProcessValidCategoryPath() throws CartridgeHandlerException {
    mGuidedNavigationHandler.getStoreCartridgeTools()
      .getCatalogNavigation().setCurrentCategory("catMen");

    mGuidedNavigationHandler.getStoreCartridgeTools()
      .getCatalogNavigation().setCurrentCategoryValid(true);

    BasicContentItem contentItem = mGuidedNavigationHandler.process(new BasicContentItem());
  ...
  public void testProcessNoCategoryPath() throws CartridgeHandlerException {
    mGuidedNavigationHandler.getStoreCartridgeTools().getCatalogNavigation().setCurrentCategory("");
