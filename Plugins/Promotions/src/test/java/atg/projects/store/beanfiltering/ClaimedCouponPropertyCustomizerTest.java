...
/**
 * This unit test will test the methods of the ClaimedCouponPropertyCustomizer class.
 *
 * @author Oracle
 * @version $Id: //hosting-blueprint/CSA/version/11.3/Plugins/Promotions/src/test/java/atg/projects/store/beanfiltering/ClaimedCouponPropertyCustomizerTest.java#1 $$Change: 1385662 $
 * @updated $DateTime: 2017/03/09 10:29:42 $
 */
public class ClaimedCouponPropertyCustomizerTest {

  /** Class version string */
  public static final String CLASS_VERSION =
    "$Id: //hosting-blueprint/CSA/version/11.3/Plugins/Promotions/src/test/java/atg/projects/store/beanfiltering/ClaimedCouponPropertyCustomizerTest.java#1 $$Change: 1385662 $";
  ...
  private static final String CLAIMED_COUPON_PROPERTY_CUSTOMIZER_PATH = "/atg/commerce/promotion/filter/bean/ClaimedCouponPropertyCustomizer";
  ...
  private static ClaimableManager mClaimableManager = null;
  ...
  public static void beforeClass() throws ServletException, SiteContextException {
    mNucleus = NucleusTestUtils.startNucleusWithModules(
      ...
      ClaimedCouponPropertyCustomizerTest.class, "ClaimedCouponPropertyCustomizerTest", "/atg/Initial");
    ...
    mClaimableManager = (ClaimableManager) mNucleus.resolveName(CLAIMABLE_MANAGER_PATH, true);
    assertNotNull(mClaimableManager);
  ...
  @Test
  public void testGetPropertyValue() throws RepositoryException, CommerceException, BeanFilterException {
    // This is our coupon
    ...
    mClaimableManager.claimCoupon(profileId, "FREESHIP");
    RepositoryItem claimedCoupon = mClaimableManager.findAndClaimCoupon("FREESHIP");
    ...
    String couponCode = (String) getClaimedCouponPropertyCustomizer().getPropertyValue(getOrder(), null, null);
  ...
  /**
   * @return The claimed coupon property customizer.
   */
  private ClaimedCouponPropertyCustomizer getClaimedCouponPropertyCustomizer(){
    return (ClaimedCouponPropertyCustomizer) ServletUtil.getCurrentRequest().resolveName(CLAIMED_COUPON_PROPERTY_CUSTOMIZER_PATH);
  }
