 ...
 *
 * @author Oracle
 * @version $Id: //hosting-blueprint/CSA/version/11.3/Plugins/Promotions/src/test/java/atg/commerce/promotion/StoreCouponFormHandlerTest.java#1 $$Change: 1385662 $
 * @updated $DateTime: 2017/03/09 10:29:42 $
 */
public class StoreCouponFormHandlerTest {

  /** Class version string */
  public static final String CLASS_VERSION =
    "$Id: //hosting-blueprint/CSA/version/11.3/Plugins/Promotions/src/test/java/atg/commerce/promotion/StoreCouponFormHandlerTest.java#1 $$Change: 1385662 $";

  //---------------------------------------------------------------------------
  // STATIC
  //---------------------------------------------------------------------------

  private static final String COUPON_FORMHANDLER_PATH = "/atg/commerce/promotion/CouponFormHandler";
  ...
  public static void beforeClass() throws ServletException, SiteContextException {
    mNucleus = NucleusTestUtils.startNucleusWithModules(
      ...
      StoreCouponFormHandlerTest.class, "StoreCouponFormHandlerTest", "/atg/Initial");
  ...
  @Test
  public void testHandleRemoveCoupon() throws CommerceException, RepositoryException, ServletException, IOException {
    // This is our coupon
    ...
    // Remove the coupon
    StoreCouponFormHandler scfh = getStoreCouponFormHandler();
    assertNotNull(scfh);

    scfh.handleRemoveCoupon(ServletUtil.getCurrentRequest(), null);
  ...
  /**
   * @return The store coupon form handler
   */
  private StoreCouponFormHandler getStoreCouponFormHandler(){
    return (StoreCouponFormHandler) ServletUtil.getCurrentRequest().resolveName(COUPON_FORMHANDLER_PATH);
  }
