...
/**
 * This is the cartridge handler for LinkContent type cartridges.
 *
 * @author Oracle
 * @version $Id: //hosting-blueprint/CSA/version/11.3/Base/src/main/java/atg/projects/store/assembler/cartridge/handler/LinkContent.java#1 $$Change: 1385662 $
 * @updated $DateTime: 2017/03/09 10:29:42 $
 */
public class LinkContent extends NavigationCartridgeHandler {

  /** Class version string. */
  public static String CLASS_VERSION =
    "$Id: //hosting-blueprint/CSA/version/11.3/Base/src/main/java/atg/projects/store/assembler/cartridge/handler/LinkContent.java#1 $$Change: 1385662 $";
  ...
  /**
   * This process method will process the cartridge's link, creating the appropriate
   * navigation action. This ensures that links containing dimension value IDs will
   * be converted into the correct navigation paths i.e. SEO formatted paths if configured
   * to do so in the current NavigationStateBuilder.
   *
   * For example, if a link contains the value "N=1234567", the action path generated
   * will be in the format of /_/N-cT234.
   *
   * @param pContentItem
  ...
  public ContentItem process(ContentItem pContentItem) throws CartridgeHandlerException {
    LinkBuilder linkBuilder = (LinkBuilder) pContentItem.get(LINK_PROPERTY_NAME);

    if (linkBuilder != null) {
      try {
        pContentItem.put(LINK_PROPERTY_NAME, linkBuilder.createAction(
