...
/**
 * Get the current InventoryInfo for a CommerceItem.
 *
 * @author Oracle
 * @version $Id: //hosting-blueprint/CSA/version/11.3/Base/src/main/java/atg/projects/store/inventory/filter/bean/InventoryInfoForCommerceItemPropertyCustomizer.java#1 $$Change: 1385662 $
 * @updated $DateTime: 2017/03/09 10:29:42 $
 */
public class InventoryInfoForCommerceItemPropertyCustomizer extends GenericService
    implements PropertyCustomizer {

  /** Class version string. */
  protected static final String CLASS_VERSION =
    "$Id: //hosting-blueprint/CSA/version/11.3/Base/src/main/java/atg/projects/store/inventory/filter/bean/InventoryInfoForCommerceItemPropertyCustomizer.java#1 $$Change: 1385662 $";
  ...
  /**
   * Get the current InventoryInfo for the CommerceItem.
   *
   * @param pTargetObject
   ...
   * @param pAttributes
   *   Name/value pair attributes defined in the beanFilteringConfiguration.xml
   *   file for this property.
   *
   * @return
   *   The InventoryInfo for the CommerceItem.
   *
  ...
  public Object getPropertyValue(Object pTargetObject, String pPropertyName,
    ...
    if (pTargetObject instanceof CommerceItem) {
      CommerceItem commerceItem = (CommerceItem) pTargetObject;
      String catalogRefId = commerceItem.getCatalogRefId();

      return new InventoryInfo(catalogRefId, getInventoryManager());
    }
