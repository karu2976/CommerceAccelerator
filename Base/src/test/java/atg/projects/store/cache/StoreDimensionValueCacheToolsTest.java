...
/**
 * This unit test will test the methods of the StoreDimensionValueCacheTools class.
 * 
 * @author Oracle
 * @version $Id: //hosting-blueprint/CSA/version/11.3/Base/src/test/java/atg/projects/store/cache/StoreDimensionValueCacheToolsTest.java#1 $$Change: 1385662 $
 * @updated $DateTime: 2017/03/09 10:29:42 $
 */
public class StoreDimensionValueCacheToolsTest {

  /** Class version string */
  public static final String CLASS_VERSION =
    "$Id: //hosting-blueprint/CSA/version/11.3/Base/src/test/java/atg/projects/store/cache/StoreDimensionValueCacheToolsTest.java#1 $$Change: 1385662 $";

  //----------------------------------------------------------------------------
  // STATIC MEMBERS
  //----------------------------------------------------------------------------

  private static StoreDimensionValueCacheTools mStoreDimensionValueCacheTools = null;
   ...
   * the StoreDimensionValueCacheTools instance to be used in this test.
   *
  ...
  public static void setUpBeforeClass() throws ServletException, RepositoryException, PropertyNotFoundException {
    mNucleus = NucleusTestUtils.startNucleusWithModules(
      ...
      StoreDimensionValueCacheToolsTest.class,
      "StoreDimensionValueCacheToolsTest",
      "/atg/Initial");
    ...
    mStoreDimensionValueCacheTools = (StoreDimensionValueCacheTools)
      mRequest.resolveName("/atg/commerce/endeca/cache/DimensionValueCacheTools", true);

    assertNotNull(mStoreDimensionValueCacheTools);
  ...
  public static void tearDownAfterClass() throws IOException, ServiceException {
    ...
    mStoreDimensionValueCacheTools = null;
  ...
  /**
   * Ensure that no ancestors are returned.
   */
  @Test
  public void testGetAncestorIdsNoAncestor() {
    List<String> ancestors = mStoreDimensionValueCacheTools.getAncestorIds("catMen");
    assertEquals(0, ancestors.size());
  }

  /**
   * Ensure that only a single ancestor is returned.
   */
  @Test
  public void testGetAncestorIdsSingleAncestor() {
    List<String> ancestors = mStoreDimensionValueCacheTools.getAncestorIds("cat50077");
    assertEquals(1, ancestors.size());
    assertEquals("catMenShirts", ancestors.get(0));
  }

  /**
   * Ensure that last 2 ancestors are returned.
   */
  @Test
  public void testGetAncestorIdsTwoAncestors() {
    List<String> ancestors = mStoreDimensionValueCacheTools.getAncestorIds("cat12345");
    assertEquals(2, ancestors.size());
    assertEquals("catMenShirts", ancestors.get(0));
    assertEquals("cat50077", ancestors.get(1));
  }
