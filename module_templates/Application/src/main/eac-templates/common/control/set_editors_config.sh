...
"${WORKING_DIR}/runcommand.sh" IFCR importContent editors ${WORKING_DIR}/../config/import/editors
if [ $? != 0 ]; then
  exit 1
fi 

# Replace configuration from ..\config\import\configuration\tools\xmgr
